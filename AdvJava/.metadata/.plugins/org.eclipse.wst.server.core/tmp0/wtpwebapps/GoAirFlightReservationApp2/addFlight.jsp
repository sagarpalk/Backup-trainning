			...
			<div class="card-body bg bg-warning border border-danger rounded">
				<form action="AddFlightController2" method="post">
					...
					<fieldset class="form-group">
						<label>Flight Name</label> <input type="text" class="form-control"
							name="flight_name">
					</fieldset>
					...
					<fieldset class="form-group">
						<label>Flight Type</label> <input type="text" class="form-control"
							name="flight_type">
					</fieldset>
					...
					<fieldset class="form-group">
						<label>Economic Class Seat's Price: </label> <input type="number"
							class="form-control" name="economicPrice">
					</fieldset>
					...
					<fieldset class="form-group">
						<label>Flight Time</label> <input type="time" class="form-control"
							name="flight_time">
					</fieldset>
