...
<body>
	<header>
		<nav class="navbar navbar-dark bg-info navbar-fixed-top">
			...
			<ul class="navbar-nav">
				<li><a href="<%=request.getContextPath()%>/AddNewFlilght.jsp"
					class="btn btn-warning btn-sm">Add flight</a></li>
			</ul>
			<ul class="navbar-nav">
				<li><a href="<%=request.getContextPath()%>/ScheduleFlight.jsp"
					class="btn btn-dark btn-sm">Schedule flight</a></li>
			</ul>
			<ul class="navbar-nav ">
					...
					<h1>Add Flight</h1>
						...
						<fieldset class="form-group">
							<label>Service Provider</label> <input type="text"
								class="form-control" name="flight_service_provider">
						</fieldset>
						...
						<fieldset class="form-group">
							<label>Premium Seats</label> <input type="text"
								class="form-control" name="premium_seats">
						</fieldset>
						...
						<fieldset class="form-group">
							<label>Premium Class Seat's Price:</label> <input type="text"
								class="form-control" name="premiumPrice">
						</fieldset>

						<fieldset class="form-group">
							<label>Business Class Seat's Price: </label> <input type="text"
								class="form-control" name="businessPrice">
						</fieldset>
			...
			<div class="card-body bg bg-warning border border-danger rounded">
				<form action="AddFlightController2" method="post">
					<h1>Add Flight</h1>
						...
						<fieldset class="form-group">
							<label>Flight Time</label> <input type="date"
