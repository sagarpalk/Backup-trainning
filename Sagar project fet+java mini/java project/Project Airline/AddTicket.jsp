    ...
    <body>
        ...
        String received=request.getParameter("Received");
           ...
           try
           {
               ...
               String query="insert into DeccanBook(FullName,Address,City,PhoneNO,MobileNo,From1,To1,DepartureDt,ReturnDt,Person,TotalRs,Received) values('"+fullname+"','"+address+"','"+city+"','"+phoneno+"','"+mobileno+"','"+from1+"','"+to1+"','"+departuredt+"','"+returndt+"','"+person+"','"+totalrs+"','"+received+"')";
