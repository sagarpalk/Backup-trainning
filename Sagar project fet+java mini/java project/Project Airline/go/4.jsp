...
<%
        ...
        String totalrs=request.getParameter("TotalRs");
           ...
           try
           {
               ...
               String query="insert into GoBook(No,FullName,Address,City,PhoneNo,MobileNo,From1,To1,DepartureDt,ReturnDt,Person,TotalRs,Received) values('"+flightno+"','"+fullname+"','"+address+"','"+city+"','"+phoneno+"','"+mobileno+"','"+from1+"','"+to1+"','"+departuredt+"','"+returndt+"','"+person+"','"+amt+"','"+totalrs+"')";
