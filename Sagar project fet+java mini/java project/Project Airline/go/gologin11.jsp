...
<table width="885" border="0" cellpadding="0" cellspacing="0" align="center"  bgcolor="#33CCFF">
  ...
  <tr>
    ...
    <td colspan="2" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="blue">
      ...
      <tr>
        <td width="4"> </td>
          <td width="674" height="400" valign="top"><center><h3>&nbsp;c</h3>
			  <font face=Arial, Arial, Helvetica></font>
			<h3> <font face=Arial, Arial, Helvetica color=#FFFFFF> <font 	face=Book Antiqua size=5> <b> Login</b></font></font><font face=Arial, Arial, Helvetica></font></h3>
			<table border=2 bordercolorlight=#999999 bordercolordark=#000000>
  <form name="f1" method="get" action="declogin11.jsp">
...
<p>&nbsp; &nbsp; &nbsp;<font color="#FF00FF">invalid username and password pleasw enter again.....</font> </p>
            <p>&nbsp;</p></td>
        </tr>
