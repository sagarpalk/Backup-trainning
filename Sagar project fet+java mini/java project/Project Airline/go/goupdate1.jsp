    ...
    <body>
        ...
        String totalrs=request.getParameter("TotalRs");
           ...
           try
           {
               ...
               String query= "update GoBook  set  FullName='"+fullname+"', Address='"+address+"', City='"+city+"', MobileNo='"+mobileno+"', From1='"+from1+"',To1='"+to1+"' , DepartureDt='"+departuredt+"', ReturnDt='"+returndt+"', Person='"+person+"', TotalRs='"+totalrs+"' where PhoneNo="+phoneno+"";
		...
		<%@include file="gomodifyticket.jsp" %> 
