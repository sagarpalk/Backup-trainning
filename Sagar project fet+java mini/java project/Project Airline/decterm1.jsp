...
<table width="885" border="0" cellpadding="0" cellspacing="0" align="center"  bgcolor="#33CCFF">
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td colspan="2" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#0066FF">
      <!--DWLayoutTable-->
      <tr>
        <td width="4"></td>
          <td width="674" height="400" valign="top"><%@include file="deccterms.jsp" %> </td>
        </tr>
